  ...
  return (
    <section id='home' className="relative pt-32 pb-20 overflow-hidden flex flex-col items-center">
      ...
      <div className="text-center z-10 px-4 max-w-5xl">
        ...
        >
          Rekrut Worker 
          <span className="inline-flex items-center justify-center align-middle mx-3 bg-white text-blue-600 p-2 rounded-xl shadow-[0_0_20px_rgba(255,255,255,0.4)] rotate-3 hover:rotate-6 transition-transform">
            <TrendingUp size={32} strokeWidth={3} />
          </span> 
          Ai untuk <br className="hidden md:block" />
          <span className="bg-gradient-to-r from-white via-white to-[#8F8F8F] text-transparent bg-clip-text inline-block">Kebutuhan Anda.</span>
        </motion.h1>
        ...
        >
          Bukan AI generik. Ini worker Ai yang sudah dilatih untuk <br className="hidden md:block" />

...
const PRODUCTS_DB = {
  1: {
    ...
    description:
      "Create the ultimate gaming environment with our premium industry-standard equipment designed for professional esports and immersive gameplay.",
    basePrice: 5000000,
  ...
  2: {
    ...
    description:
      "Transform your living room into a cinematic paradise with our state-of-the-art entertainment systems.",
    basePrice: 3000000,
...
const Productcard = () => {
  ...
  const isBundle =
    activeAdds.length === product.customAdds.length &&
    product.customAdds.length > 0;
  ...
  const handleWhatsAppRedirect = () => {
    const selectedAddDetails = activeAdds
      .map((id) => {
  ...
  return (
    <section className="relative min-h-screen py-24 md:py-32 overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div
          className="absolute top-[10%] left-[20%] w-[500px] h-[500px] bg-blue-600/20 blur-[120px] rounded-full mix-blend-screen animate-pulse"
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div
          id="customize"
          className="relative rounded-[3rem] border border-white/10 bg-[#081028]/80 backdrop-blur-xl overflow-hidden shadow-2xl"
        >
          {/* Header */}
          <div className="p-8 md:p-12 border-b border-white/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div>
              ...
              >
                <Sparkles
                  size={16}
                  className={isBundle ? "text-yellow-400" : "text-gray-400"}
                />
